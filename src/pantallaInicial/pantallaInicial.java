...
public class pantallaInicial extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(autenticadoObj != null && (boolean) autenticadoObj) {
			...
			out.println("<a class='dropdown-item' href='/Proyecto_SW1/tematica?tema=2'>PCs y electrÛnica</a>");
			...
			out.println("</div></li>");
			out.println("<li class='nav-item'><a class='nav-link' href='#'>Cerrar SesiÛn</a></li>");
			out.println("</ul>");
			out.println("</div>");
			out.println("</nav>");
			...
			try {
				...
				//HACER:
				//Poner al select una limitaci√≥n (LIMIT 20) o algo as√≠
