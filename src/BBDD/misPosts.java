...
public class misPosts extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (autenticadoObj != null && (boolean) autenticadoObj) {
			...
			out.println("</div></li>");
			out.println("<li class='nav-item'><a class='nav-link' href='/Proyecto_SW1/Pyet'>Cerrar SesiÛn</a></li>");
			out.println("</ul>");
			out.println("</div>");
			out.println("</nav>");
			...
			try {
				...
				// contrase√±a carlos:
				// connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/p2",
