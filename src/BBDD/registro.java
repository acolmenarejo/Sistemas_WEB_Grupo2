...
//<<<<<<< HEAD
		...
		String contraseÒa = req.getParameter("contraseÔøΩa");
		System.out.println(contraseÒa);
//=======
		String contrasena = req.getParameter("contrasena");
		System.out.println(contrasena);
//>>>>>>> 9da80631671a4997b7c41e1d87739bec33a41922
		...
		try {
//<<<<<<< HEAD
		String query = "insert into usuario values( NULL,'" + nombreusuario + "', '" + contraseÒa + "', '" + correo + "')";
//=======
		...
		/*
			...
			while(resultSet.next()) {
				...
				if(query!="NULL" || resultSet.getString("correo").equals(correo)) {
					...
					query = "insert into usuario values( NULL,'A', '" + contrase√±a + "', '" + correo + "')";
				}
